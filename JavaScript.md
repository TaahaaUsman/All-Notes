...
## const
const asa variable hota ha jis ki value ko banana ka bad ham chage/update nahi kar sakta, ya same rahta ha

## What is hoisting in javascript?
Hoisting javascript ka ak feature ha, ager ham koi function banain aor os ma variable ko use kar lain lakin vaiable ko function ka bad define karin to baki proggramming languages error dain gi lakin js ka ander ya behavior acceptable isa ham hoisting kahta han
...
# Async Concepts
## Sync and Async javascript hoti kaya ha?
...
## Kasa pata chala ga ka hamara code sync ha async ha?
```
setInterval
setTimeout
promises
...
XMLHttpRequest
```
_Ager hamara code ma in cheezon ma sa koi cheez use hoi ha to hamara code async ha aor ager nahi hoi to sync code ha._
...
## Singal threading and multi threading
...
## Diffrence between textContent and innerHTML
